...
if ( post_password_required() ) {
    ?><p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.','kbe') ?></p><?php
    return;
}
...
// this is displayed if there are no comments so far
    ...
    if ( comments_open() ) :
        ...
        ?><p class="nocomments"><?php _e('Comments are closed.','kbe'); ?></p><?php
    endif;
    ...
    if ( comments_open() ) :
        ...
        ?><div id="respond">
            ...
            if ( get_option('comment_registration') && !is_user_logged_in() ) :
                ...
                ?><p><?php
                    _e('You must be ','kbe');
                    ?><a href="<?php echo wp_login_url( get_permalink() ); ?>"><?php _e('logged in','kbe'); ?></a><?php
                    _e('to post a comment.','kbe');
                ?></p><?php
                ...
                if ( is_user_logged_in() ) :
                    ...
                    ?><p><?php
                        ...
                        ?><a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php
                            echo $user_identity;
                        ?></a>. 
                        <a href="<?php echo wp_logout_url(	get_permalink()); ?>" title="<?php _e('Log out of this account','kbe') ?>"><?php
                            _e('Log out &raquo;','kbe');
                        ?></a>
                    </p><?php
                    ...
                    <input type="hidden" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" /><?php
                ...
                ?><!--<p><small><strong>XHTML:</strong> You can use these tags: <code><?php echo allowed_tags(); ?></code></small></p>-->
                    ...
                    <input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Post Comment','kbe'); ?>" /><?php
