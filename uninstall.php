...
//=========> Get Knowledgebase page and Delete all relivent Data
	$kbe_get_page = $wpdb->get_results("Select * From ".$wpdb->prefix."posts Where post_content like '%[kbe_knowledgebase]%' and post_type = 'page'");
...
//=========> Delete All Images and Files of Knowledgebase in Theme
	$kbe_image_theme_dir = get_template_directory()."/images/";
	...
	// Get Files
	$kbe_delete_archive = get_template_directory().'/archive-kbe_knowledgebase.php';
    $kbe_delete_kbe = get_template_directory().'/kbe_knowledgebase.php';
    $kbe_delete_style = get_template_directory().'/kbe_style.css';
    $kbe_delete_single = get_template_directory().'/single-kbe_knowledgebase.php';
    $kbe_delete_taxonomy = get_template_directory().'/taxonomy-kbe_taxonomy.php';
    $kbe_delete_tags = get_template_directory().'/taxonomy-kbe_tags.php';
    $kbe_delete_comment = get_template_directory().'/kbe_comments.php';
    $kbe_delete_search = get_template_directory().'/kbe_search.php';
