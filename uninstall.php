...
unlink($kbe_image_theme_dir."/kbe_bg_reply.png");
unlink($kbe_image_theme_dir."/kbe_breadcrum_sep.png");
unlink($kbe_image_theme_dir."/kbe_icon_arrow.png");
unlink($kbe_image_theme_dir."/kbe_icon_list_tag.png");
unlink($kbe_image_theme_dir."/kbe_icon_reply.png");
unlink($kbe_image_theme_dir."/kbe_icon_search_list.png");
unlink($kbe_image_theme_dir."/kbe_icon_tag.png");
unlink($kbe_image_theme_dir."/kbe_large.png");
unlink($kbe_image_theme_dir."/kbe_med.png");
unlink($kbe_image_theme_dir."/kbe_search_btn.png");
unlink($kbe_image_theme_dir."/kbe_icon-minus.png");
unlink($kbe_image_theme_dir."/kbe_icon-plus.png");
	
rmdir($kbe_image_theme_dir);

// Get Files
$kbe_delete_archive = get_template_directory().'/wp_knowledgebase/archive-kbe_knowledgebase.php';
$kbe_delete_kbe = get_template_directory().'/wp_knowledgebase/kbe_knowledgebase.php';
$kbe_delete_style = get_template_directory().'/wp_knowledgebase/kbe_style.css';
$kbe_delete_single = get_template_directory().'/wp_knowledgebase/single-kbe_knowledgebase.php';
$kbe_delete_taxonomy = get_template_directory().'/wp_knowledgebase/taxonomy-kbe_taxonomy.php';
$kbe_delete_tags = get_template_directory().'/wp_knowledgebase/taxonomy-kbe_tags.php';
$kbe_delete_comment = get_template_directory().'/wp_knowledgebase/kbe_comments.php';
$kbe_delete_search = get_template_directory().'/wp_knowledgebase/kbe_search.php';

$kbe_delete_knowledgebase = get_template_directory().'/wp_knowledgebase';
...
rmdir($kbe_delete_knowledgebase);